...
import Stats from '/three-pcb/jsm/stats.module.js';
import { GUI } from '/three-pcb/jsm/lil-gui.module.min.js';
import { OrbitControls } from '/three-pcb/jsm/OrbitControls.js';
import { GLTFLoader } from '/three-pcb/jsm/GLTFLoader.js';
import { EffectComposer } from '/three-pcb/jsm/EffectComposer.js';
import { RenderPass } from '/three-pcb/jsm/RenderPass.js';
import { UnrealBloomPass } from '/three-pcb/jsm/UnrealBloomPass.js';
import { SVGLoader } from '/three-pcb/jsm/SVGLoader.js';
    ...
    let camera, stats;
            ...
            function createGUI(scene, bloomPass) {
                ...
                gui.add( guiData, 'currentURL', {
                    "Circuit": '/three-pcb/assets/circuit.svg',
            ...
            function init(scene, bloomPass) {
                ...
                guiData = {
                    currentURL: '/three-pcb/assets/circuit.svg',
                    drawFillShapes: true,
                    drawStrokes: true,
		...
		loadSVG('/three-pcb/assets/circuit.svg', scene);	
